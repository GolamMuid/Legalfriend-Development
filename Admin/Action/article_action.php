...
$insert = "INSERT into articles (message_date, image, name, designation, address, headline, body, url, image_title) values('$message_date', '$message_image', '$message_speaker_name','$message_speaker_designation', '$message_speaker_address', '$message_headline', '$message_body', '$url_link', '$image_title');";
