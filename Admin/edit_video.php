                  ...
                  <div class="x_content">
                    <br />
                            <?php
                                ...
                                ?>
                    <form class="form-horizontal form-label-left" enctype="multipart/form-data" action="Action/edit_video_action.php?id=<?php echo $id; ?>" method="post">
