                  ...
                  <div class="x_content">
                    <br />
                            <?php
                                ...
                                ?>
                    <form class="form-horizontal form-label-left" enctype="multipart/form-data" action="Action/edit_about_action.php?id=<?php echo $id; ?>" method="post">


                     <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Company Name:</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                          <input type="text" name="notification_date" class="form-control" value="<?php echo $notification_date; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label class="control-label col-md-3 col-sm-3 col-xs-3">Company Logo:</label>
                        <div class="col-md-6 col-sm-6 col-xs-6">
